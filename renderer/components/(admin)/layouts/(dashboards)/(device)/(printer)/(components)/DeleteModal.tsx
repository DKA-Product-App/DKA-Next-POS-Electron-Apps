...
export const DeleteModal = ({ id, name, onDeleted }: { id: string; name?: string; onDeleted?: () => void }) => {
    ...
    const openConfirm = React.useCallback(() => {
        setSwalProps({
            ...
            icon: 'warning',
            title: 'Hapus Data?',
            html: `Anda akan menghapus <b>${name || 'Data ini'}</b>. Tindakan ini tidak dapat dibatalkan.`,
            ...
            onConfirm: () => {
                ...
                window?.api?.invoke?.('api.config.device.printer:delete.one', { id })
                    .then((resolve) => {
                        console.log(resolve);
                        setSwalProps({
                            show: true,
                    ...
                    .catch((err) => {
                        ...
                        setSwalProps({
                            ...
                            theme: mode,
                            timer: 5000,
                            text: err?.msg || err?.message || 'Gagal menghapus Data',
