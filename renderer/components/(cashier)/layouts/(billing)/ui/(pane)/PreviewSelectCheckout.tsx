...
// const DiscountWidget = dynamic(() => import("./components/DiscountWidget"), { ssr: false });
                            ...
                            return (
                                <Fade in key={it.key} timeout={180}>
                                    <Box>
                                        <ListItem
                                            secondaryAction={
                                                <Actions k={it.key} qty={it.qty} onInc={inc} onDec={dec} onRemove={remove} />
                                            }
                                            sx={{
                                                px: 1.5,
                                                py: 1,
                                        ...
                                        >
                                            <ListItemText
                                                primary={
                                                    <Stack direction="row" spacing={1} alignItems="center">
                                                        <Typography fontWeight={900} lineHeight={1.2} title={it.name}
                                                                    sx={{
                                                                        display: "-webkit-box",
                                                                        WebkitLineClamp: 1,
