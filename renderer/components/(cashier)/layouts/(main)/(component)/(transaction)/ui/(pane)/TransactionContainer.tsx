...
function Body() {
    const { header, txId, grandTotal, setGrandTotal, selectedItemIds, selectedTotal, clearSelection, selectedBatchId, bumpReload } = useTx()
            ...
            <Stack direction="row" alignItems="center" justifyContent="space-between" flexWrap="wrap" gap={1.5}>
                ...
                <Box sx={{ display: 'grid', gap: 0.5, minWidth: 260 }}>
                    ...
                    <Typography sx={{ lineHeight: 1, fontWeight: 900, fontSize: { xs: '1.6rem', sm: '1.9rem', md: '2.1rem' } }}>
                        {selectedItemIds.size === 0 ? (grandTotal > 0 ? rupiah(grandTotal) : 0) : rupiah(selectedTotal)}
                    </Typography>
