            ...
            >
                <Stack spacing={1.25} alignItems="center">
                    ...
                    <Typography variant="h6" fontWeight={900}>
                        Tidak ada Bill (Tagihan) yang dipilih
                    </Typography>
                    <Typography variant="body2" color="text.secondary">
                        Silakan pilih salah satu Bill pada panel kiri untuk menampilkan rincian lengkapnya.
                        Anda dapat menggunakan kolom pencarian Nomor Bill, Jumlah Bill dan Status Bill untuk mempersempit hasil.
